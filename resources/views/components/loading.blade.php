{{-- <div wire:loading class="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-900 opacity-75 z-50">
    <img src="{{asset('storage/loads/cargando.gif')}}" alt="Cargando">
</div>
 --}}
