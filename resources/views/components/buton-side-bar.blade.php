    ...
    $classes =
        $active ?? false
            ? 'block text-sm w-full pl-3 pr-4 py-2 border-l-4 border-blue-800 dark:border-blue-600
             text-left text-base font-medium text-indigo-700 dark:text-indigo-300 bg-blue-100
            ...
            hover:bg-blue-700 dark:hover:bg-sky-700 hover:border-gray-300 dark:hover:border-gray-600
