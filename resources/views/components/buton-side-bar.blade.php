    ...
    $classes =
        $active ?? false
            ? 'block text-sm w-full pl-3 pr-4 py-2 border-l-4 border-blue-800 dark:border-blue-600
             text-left text-base font-medium text-verde-700 dark:text-black bg-blue-100
             dark:bg-gray-200 focus:outline-none focus:text-verde-800 dark:focus:text-blue-200
            ...
            hover:bg-verde-200 dark:hover:bg-sky-700 hover:border-gray-300 dark:hover:border-gray-600
